...
<body class="bg-gray-200">
    <div class="flex flex-col h-screen justify-between">
        ...
        ?>
				<?php // show logged user name in current session else show login form 
        ...
        <div class="max-w-md mx-auto container bg-white p-6 rounded-md shadow-md">
            ...
            >
                ...
                <div class="mb-4 mt-4 w-full flex justify-center space-x-6">
                    ...
                    <button type="button" class="bg-green-500 text-white rounded-md px-4 py-2 hover:bg-green-600" onclick="window.location.href='index.php?page=userForm'">Registrar</button>
                </div>
            </form>					
        </div>
				<?php endif; ?>
